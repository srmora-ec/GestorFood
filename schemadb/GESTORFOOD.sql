...
CREATE TABLE IF NOT EXISTS public.impuestos (
  id_impuesto integer NOT NULL PRIMARY KEY,
  nombre character varying NOT NULL UNIQUE,
  porcentaje numeric(5, 2) NOT NULL
);

CREATE UNIQUE INDEX IF NOT EXISTS public_impuestos_nombre_key ON public.impuestos (nombre);
CREATE UNIQUE INDEX IF NOT EXISTS public_impuestos_pkey ON public.impuestos (id_impuesto);
CREATE INDEX IF NOT EXISTS public_impuestos_nombre_0060a69b_like ON public.impuestos (nombre);
...
CREATE TABLE IF NOT EXISTS public.producto_impuestos (
  id bigint NOT NULL PRIMARY KEY,
  id_impuesto integer NOT NULL,
  id_producto integer NOT NULL
);

CREATE UNIQUE INDEX IF NOT EXISTS public_producto_impuestos_id_producto_id_impuesto_9a788a81_uniq ON public.producto_impuestos (id_producto, id_impuesto);
CREATE INDEX IF NOT EXISTS public_producto_impuestos_id_impuesto_6e49bd66 ON public.producto_impuestos (id_impuesto);
CREATE INDEX IF NOT EXISTS public_producto_impuestos_id_producto_adb759e1 ON public.producto_impuestos (id_producto);
CREATE UNIQUE INDEX IF NOT EXISTS public_producto_impuestos_pkey ON public.producto_impuestos (id);
...
ALTER TABLE public.producto_impuestos ADD CONSTRAINT producto_impuestos_id_impuesto_6e49bd66_fk_impuestos FOREIGN KEY (id_impuesto) REFERENCES public.impuestos (id_impuesto);
ALTER TABLE public.producto_impuestos ADD CONSTRAINT producto_impuestos_id_producto_adb759e1_fk_producto_id_producto FOREIGN KEY (id_producto) REFERENCES public.producto (id_producto);
